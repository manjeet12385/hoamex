...
for file in glob.glob('*.html'):
    ...
    # Regex to find <div class="svc-row"> that contains onclick="addToCart" and <div class="options-text">
    # Because HTML can be tricky, we split by svc-row and reconstruct.
