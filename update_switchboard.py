...
# Replace the onclick of Switchboard repair Add button
content = re.sub(
    r'<button class="add-btn" onclick="addToCart\(\'Switchboard repair & replacement\', 99\)"',
    r'<button class="add-btn" onclick="document.getElementById(\'switchboard-repair-modal\').style.display=\'flex\'"',
    content
)

# Modal HTML to inject
modal_html = """
    <!-- Switchboard repair Modal -->
                ...
                <div style="position: relative;">
                    <div id="modal-carousel-switchboard-repair" class="wm-options-carousel" style="display: flex; gap: 15px; overflow-x: auto; padding-bottom: 10px; scrollbar-width: none; scroll-behavior: smooth;">
                        ...
                        <div class="option-card" style="min-width: 150px; flex: 1; border: 1px solid #eee; border-radius: 8px; overflow: hidden; padding: 16px; display: flex; flex-direction: column; background: #fff;">
                            ...
                            <div class="option-rating" style="font-size: 12px; margin-bottom: 10px;"><i class="fa-solid fa-star" style="color: #6366f1;"></i> 4.80 <span style="color: #666;">(200 reviews)</span></div>
