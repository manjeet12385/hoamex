...
<head>
    ...
    <style>
        ...
        /* Banner */
        .uc-difference-banner { background: #e8e8e8; border-radius: 14px; padding: 30px 30px 30px 30px; margin-bottom: 30px; position: relative; display: flex; align-items: center; justify-content: flex-start; overflow: hidden; min-height: 300px; background-size: cover; background-position: center; color: white;}
        ...
        .banner-text h2 { font-size: 38px; font-weight: 700; margin: 0; line-height: 1.2; text-shadow: 1px 1px 4px rgba(0,0,0,0.3); }
...
<body>
    ...
    <header class="header">
        ...
        <div class="search-container">
            ...
            <input type="text" placeholder="Search for 'Spa Luxe'">
        </div>
    ...
    <main class="page-wrapper">
        ...
        <div class="top-section" style="display: flex; justify-content: space-between; align-items: flex-start;">
            <div>
                <h1 class="page-title" style="font-size: 32px; margin-bottom: 5px;">Spa Luxe</h1>
                <div class="page-rating">
                    <i class="fa-solid fa-star" style="color: #000;"></i>
                    <strong>4.89</strong>
                    <span>(990K bookings)</span>
                </div>
            </div>
            <div style="background: #e8f5e9; color: #2e7d32; padding: 5px 10px; border-radius: 6px; text-align: center; border: 1px solid #c8e6c9;">
                ...
                <div style="font-size: 12px; margin-top: 2px; font-weight: bold;">Tue, 9:00 AM</div>
            </div>
        </div>
            ...
            <div class="left-sidebar">
                <div class="select-service-card">
                    ...
                    <div class="service-grid">
                        ...
                        <a href="#natural-skincare" class="service-item">
                            <div class="service-item-img">
                                <img src="images/beauty.jpg" alt="Natural skincare">
                            </div>
                            <span style="font-size: 10px; color: #333;">Natural skincare</span>
                        </a>
                    ...
                    <div class="service-card" style="border-bottom: 1px solid #eee; padding-bottom: 25px; margin-bottom: 25px; align-items: stretch; position: relative;">
                        <div class="service-card-info" style="flex: 1; padding-right: 20px;">
                            ...
                            <div class="service-price" style="margin-bottom: 15px; font-size: 13px; color: #444;">
                                <span style="font-weight: 700; color: #000;">₹1299</span> &bull; <span>60 mins</span>
                            </div>
...
"""
    with open("spa-luxe.html", "w", encoding="utf-8") as f:
